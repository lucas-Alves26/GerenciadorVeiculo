...
SELECT v.VEI_INT_ID, E.EMP_INT_ID FROM TBL_VEICULO AS V 
INNER JOIN TBL_EMPRESA AS E ON E.EMP_INT_ID = V.EMP_INT_ID WHERE  V.VEI_INT_ID = 1

DELETE TBL_VEICULO WHERE VEI_INT_ID = 1
