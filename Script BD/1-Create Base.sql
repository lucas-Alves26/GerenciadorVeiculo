...
VEI_DATE_FAB int,
VEI_DATE_ANO_MODELO int,
VEI_STR_TIPO VARCHAR(20),
VEI_STR_STATUS VARCHAR(15),
VEI_STR_SITUACAO VARCHAR(15)
)
---PRIMARY KEY
...
(
SAI_INT_ID INT NOT NULL IDENTITY(1,1),
FUN_INT_ID INT NOT NULL,
MOT_INT_ID INT NOT NULL,
VEI_INT_ID INT NOT NULL,
SAI_TIME_HORA TIME,
SAI_DATE_DATA DATE,
SAI_STR_DESC VARCHAR(100),
SAI_STR_SITUACAO VARCHAR(15)
)

---PRIMARY KEY  
ALTER TABLE TBL_SAIDA
ADD CONSTRAINT PK_SAIDA_ID PRIMARY KEY (SAI_INT_ID)
---FOREIGN KEY
ALTER TABLE TBL_SAIDA
ADD CONSTRAINT FK_SAI_FUN_ID FOREIGN KEY (FUN_INT_ID) REFERENCES TBL_FUNCIONARIO
---FOREIGN KEY
ALTER TABLE TBL_SAIDA
ADD CONSTRAINT FK_SAI_MOT_ID FOREIGN KEY (MOT_INT_ID) REFERENCES TBL_MOTORISTA
---FOREIGN KEY
ALTER TABLE TBL_SAIDA
ADD CONSTRAINT FK_SAI_VEI_ID FOREIGN KEY (VEI_INT_ID) REFERENCES TBL_VEICULO
...
SAI_INT_ID INT NOT NULL,
ENT_DATE_DATA DATE,
ENT_TIME_HORA TIME,
ENT_STR_DESC VARCHAR(100)
)

---PRIMARY KEY  
ALTER TABLE TBL_ENTRADA
ADD CONSTRAINT PK_ENTRADA_ID PRIMARY KEY (ENT_INT_ID)
---FOREIGN KEY
ALTER TABLE TBL_ENTRADA
ADD CONSTRAINT FK_SAI_ENT_ID FOREIGN KEY (SAI_INT_ID) REFERENCES TBL_SAIDA
...
MAN_DOU_VALOR FLOAT, 
MAN_DATE_DATA DATE,
MAN_TIME_HORA_INI TIME,
MAN_TIME_HORA_FIN TIME,
)

---PRIMARY KEY  
ALTER TABLE TBL_MANUTENCAO
ADD CONSTRAINT PK_MANUTENCAO_ID PRIMARY KEY (MAN_INT_ID)

---FOREIGN KEY
ALTER TABLE TBL_MANUTENCAO
ADD CONSTRAINT FK_VEI_MAN_ID FOREIGN KEY (VEI_INT_ID) REFERENCES TBL_VEICULO
...
(
SERV_INT_ID INT NOT NULL IDENTITY(1,1),
MAN_INT_ID INT,
SERV_STR_SERVICO VARCHAR(20),
SERV_STR_TIPO_SERV VARCHAR(20),
SERV_STR_OBS VARCHAR(100)
)

---PRIMARY KEY  
ALTER TABLE TBL_SERVICO
ADD CONSTRAINT PK_SERVICO_ID PRIMARY KEY (SERV_INT_ID)

---FOREIGN KEY
ALTER TABLE TBL_SERVICO
ADD CONSTRAINT FK_MAN_SER_ID FOREIGN KEY (MAN_INT_ID) REFERENCES TBL_MANUTENCAO
